...
function loadWebsitesData() {
  ...
  const files = ['substation/data/QBS.json', 'substation/data/QRS.json', 'substation/data/QUS.json','substation/data/QWS.json', 'substation/data/QMS.json', 'substation/data/websites.json', 'substation/data/alasyah.json'];
